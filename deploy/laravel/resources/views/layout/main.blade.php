...
<head>
    ...
    <title>{{ $title }} | Keuangan HMIF</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto"><span>Copyright &copy; HMIF 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    <script src="https://kit.fontawesome.com/122fa1067c.js" crossorigin="anonymous"></script>
