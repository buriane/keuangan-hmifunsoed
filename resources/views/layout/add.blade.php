...
<body id="page-top">
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; HMIF <?= date("Y"); ?></span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
    ...
    {{-- Multiple add pengurus --}}
    <script>
        let num_2 = 2;
        //ADD button
        $('#ADD-2').on('click', function(e) {
            var str = `<div id='SET-2'>
                            <div class="form-group row">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    Nama
                                </div>
                                <div class="col-sm-9">
                                    <input type="text" name="nama-${num_2}" id="nama-${num_2}" required class="form-control form-control-user" placeholder="Masukkan Nama Pengurus">
                                </div>
                            </div>
                        </div>`;
            $('#setB-2').append(str);
        ...
        //DEL button
        $('.DEL-2').on('click', function (e) {
            const element = document.getElementById("SET-2");
            element.remove();
        });
    </script>
