...
@section('content')
<?php use App\Models\Iltek; ?> 
<!-- Page Heading -->
<h1 class="h3 mb-4 text-gray-800 text-center">Laporan Keuangan Iltek {{ $judul }}</h1>
        ...
        <div class="mb-3">
            <div class="dropdown no-arrow d-inline">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                    ...
                    <a class="dropdown-item" data-toggle="modal" data-target="#create-2" href="#">Pengeluaran Iltek</a>
                    <a class="dropdown-item" data-toggle="modal" data-target="#create-3" href="#">Pengeluaran diluar Iltek</a>
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="row justify-content-lg-end d-flex">
                        <div class="col-5 col-lg-6 col-md-4">
                            <select id="bln" name="bln" type="text" class="form-control">
                                ...
                                @foreach ($bln as $data)
                                    <option value="{{ $data->bulan }}">{{ Iltek::bulan($data->bulan) }}</option>
                                @endforeach
                            </select>
                        </div>
...
<div class="card shadow mb-5">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">Pemasukan Divisi Keilmuan dan Teknologi</h6>
    </div>
    <div class="card-body">
                            ...
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" id="exampleModalLabel">Edit Pemasukan Divisi Keilmuan dan Teknologi</h5>
                                        <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">×</span>
                                        </button>
                                    </div>
                                    <div class="modal-body">
                                        <form method="post" action="/laporan-iltek/{{ $data->id }}" autocomplete="off">
                                            @csrf
                                            @method('put')
                        ...
                        <div class="modal fade" id="hapus-{{ $data->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog" role="document">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-footer">
                                        <button class="btn btn-secondary" type="button" data-dismiss="modal">Batal</button>
                                        <form action="/laporan-iltek/{{ $data->id }}" method="post">
                                            @method('delete')
                                            @csrf
...
<div class="card shadow mb-4">
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <ol class="mb-0">
                <li>Pengeluaran Dana untuk Program Kerja Divisi Keilmuan dan Teknologi</li>
            </ol>
        </h6>
    </div>
    <div class="card-body">
        <div class="table-responsive">
            <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tfoot class="text-center">
                    <tr>
                        <th colspan="4">Total</th>
                        <th style="text-align:right ;"><script> document.write(rp( {{ $laporan->where('kategori', 'Pengeluaran Iltek')->sum('pengeluaran') }} )) </script></th>
                    </tr>
                </tfoot>
                <tbody class="text-center">
                    @foreach ($laporan->where('kategori', 'Pengeluaran Iltek') as $data)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td style="text-align:left ;">{{ $data->proker }}</td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="/laporan-iltek/{{ $data->id }}" autocomplete="off">
                                            ...
                                            @method('put')
                                            <div class="form-group row">
                                                <input type="text" name="kategori" id="kategori" value="Pengeluaran Iltek" hidden>
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="bulan">Bulan</label>
                                                    <select class="form-control form-control-user" name="bulan" id="bulan" required>
    ...
    <div class="card-header py-3">
        <h6 class="m-0 font-weight-bold text-primary">
            <ol start="2" class="mb-0">
                <li>Pengeluaran Dana untuk Program Kerja diluar Divisi Keilmuan dan Teknologi</li>
            </ol>
        </h6>
    </div>
    <div class="card-body">
            ...
            <table class="table table-bordered table-striped table-hover" id="dataTable" width="100%" cellspacing="0">
                ...
                <tfoot class="text-center">
                    <tr>
                        ...
                        <th style="text-align:right ;"><script> document.write(rp( {{ $laporan->where('kategori', 'Pengeluaran diluar Iltek')->sum('pengeluaran') }} )) </script></th>
                    </tr>
                </tfoot>
                <tbody class="text-center">
                    @foreach ($laporan->where('kategori', 'Pengeluaran diluar Iltek') as $data)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form method="post" action="/laporan-iltek/{{ $data->id }}" autocomplete="off">
                                            ...
                                            @method('put')
                                            <div class="form-group row">
                                                <input type="text" name="kategori" id="kategori" value="Pengeluaran diluar Iltek" hidden>
                                                <div class="col-sm-4 mb-3 mb-sm-0">
                                                    <label for="bulan">Bulan</label>
                                                    <select class="form-control form-control-user" name="bulan" id="bulan" required>
                                                        <option value="1" {{ ($data->bulan === 1) ? 'selected' : '' }}>Januari</option>
...
<div class="modal fade" id="create-1" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pemasukan Divisi Keilmuan dan Teknologi</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
            <div class="modal-body">
                <form method="post" action="/laporan-iltek" autocomplete="off">
                    @csrf
                    <div class="form-group row">
                        <input type="text" name="kategori" id="kategori" value="Pemasukan" hidden>
                        <div class="col-sm-4 mb-3 mb-sm-0">
...
<div class="modal fade" id="create-2" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pengeluaran Divisi Keilmuan dan Teknologi</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
...
<div class="modal fade" id="create-3" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Pengeluaran diluar Divisi Keilmuan dan Teknologi</h5>
                <button class="close" type="button" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">×</span>
                </button>
            </div>
